...
The party started at 1100 but, due to botched directinos, you arrive at ${endTime}. Just as you arrive, you hear a blood-curdling scream! One of the guests has been murdered and the body of {{actor:${world.target.name}}} was just discovered in the {{loc:${world.target.location.name}}}. It appears they were killed with the {{item:${killingWeapon.name}}}.
